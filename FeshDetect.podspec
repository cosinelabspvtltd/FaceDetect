#
# Be sure to run `pod lib lint FeshDetect.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'FeshDetect'
  s.version          = '0.1.0'
  s.summary          = 'A short description of FeshDetect.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'FeshDetect/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FeshDetect' => ['FeshDetect/Assets/*.png']
  # }
